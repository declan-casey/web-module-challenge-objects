...
// console.log(createMenuItem('pizza', 12, 'food'));
...
*/
console.log(createMenuItem('chciken', 7.99, 'food'));

console.log(createMenuItem('fries', 3.99, 'food'));

console.log(createMenuItem('coke', .79 ,'drink'));
